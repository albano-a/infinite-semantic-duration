...
Busca Binária is a search algorithm used to find the position of a value within a sorted array. It begins by comparing an element in the middle of the array
